...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    tr.innerHTML = `
    <td class="user">
      <img src="http://github.com/HenriquedaFonte.png" alt="profile picture">
      <a href="http://github.com/HenriquedaFonte" target="_blank">
        <p>Henrique da Fonte</p>
        <span>/HenriquedaFonte</span>
      </a>
    </td>
    <td class="repo">
      100
